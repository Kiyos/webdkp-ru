...
<input type="hidden" name="business" value="zedd@cox.net">
...
<br />
<A HREF="https://www.paypal.com/cgi-bin/webscr?cmd=_subscr-find&alias=zedd%40cox%2enet">
...
<?php } else {?>
All the advertisments on your guild's table can be disabled for the low cost of only
<b>$1.50</b> per month. Subscribing is quick and is all handled through PayPal. You
