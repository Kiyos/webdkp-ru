...
class sql
{
	...
	============================================================*/
    function Setup($username, $password, $databaseName, $databaseServer, $createDatabase = false) // Amended - Necrojelly 2009-12-10
	{
        $this->user = $username;
        $this->pass = $password;
        $this->connect($databaseName, $databaseServer, $createDatabase);
    }
	/*===========================================================
	Connect
	...
	name to work with
	============================================================*/
    function Connect($databaseName, $databaseServer, $createDatabase = false) // Amended - Necrojelly 2009-12-10
	{
        $this->databaseName = $databaseName;
        $this->host = $databaseServer; // Added - Necrojelly 2009-12-10
