...
/**
 * Возвращает строку шестнадцатеричных кодов символов входной строки (любых),
 * предваряя каждый код знаком процента. Подходит для ASCII и UTF-8.
 * Пример: "abcde" -> "%61%62%63%64%65"
 */
...
class armory {
   ...
   */
    ...
    // This array maps ID to the class name.
		$classId2class = array(
			1 => iconv("CP1251", "UTF-8", 'Воин'),
			2 => iconv("CP1251", "UTF-8", 'Паладин'),
			3 => iconv("CP1251", "UTF-8", 'Охотник'),
			4 => iconv("CP1251", "UTF-8", 'Разбойник'),
			5 => iconv("CP1251", "UTF-8", 'Жрец'),
			6 => iconv("CP1251", "UTF-8", 'Рыцарь смерти'),
			7 => iconv("CP1251", "UTF-8", 'Шаман'),
			8 => iconv("CP1251", "UTF-8", 'Маг'),
			9 => iconv("CP1251", "UTF-8", 'Чернокнижник'),
			11 => iconv("CP1251", "UTF-8", 'Друид')
		);
